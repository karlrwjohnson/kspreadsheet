...
class DiscreteDraggable {
    ...
    _on_mouse_down(evt) {
        if (evt.buttons === this.button) {
            evt.stopPropagation();
            evt.preventDefault();
            this.emSize = libview_1.getEmSize(this.element);
        ...
        if (evt.buttons & this.button) {
            ...
            if (unitsMoved_x !== 0 || unitsMoved_y !== 0) {
                try {
                    ...
                    if (e instanceof exceptions_1.OutOfBoundsException) {
                    }
                    else {
                        throw e;
                    }
...
exports.default = DiscreteDraggable;
//# sourceMappingURL=DiscreteDraggable.js.map